Create database employee; #Creating database with name "employee"

use employee;				#Selecting Database to work with

#Creating departments table with 4 columns and Department_Id as Primary Key
...
#Creating employees table with Employee_Id as Primary Key and unique Key "Email"
CREATE TABLE  employees (
  EMPLOYEE_ID decimal(6,0) NOT NULL DEFAULT '0',
  FIRST_NAME varchar(20) DEFAULT NULL,   
  LAST_NAME varchar(25) NOT NULL,
  EMAIL varchar(25) NOT NULL,
  HONE_NUMBER varchar(20) DEFAULT NULL,
  ...
  #inserting records in empolyees
...
describe employees; #for describing Definition of employees table

SELECT  First_name,last_name,salary, CONCAT('$',round(salary + (salary * 15/100 ),2))as  New_Salary
From employees;

#4. Write a SQL query to list the employee's name and job name as a format of "Employee & Job".
select distinct concat(first_name," & ",job_title)"EMP NAME & JOB" from employees,jobs;
...
select employee_id,concat(first_name,' ',last_name)as "Employee Name",salary,date_format(hire_date,'%M,%d,%Y') "Hire Date" from employees;
...
select First_Name,trim(length(First_Name)) as "No of characters in name" from employees;
                                  #  or
select First_Name,last_name,trim(length(concat(First_Name,'',Last_name))) as "No of characters in name" from employees;

#7. Write a SQL query to find the employee ID, salary, and commission of all the employees.
select  employee_ID, salary,round(commission_pct,2) from employees order by(commission_pct) desc;

#8. Write a SQL query to find the unique department with jobs. Return department ID, Job name. 
select distinct DEPARTMENT_ID,job_title from departments,jobs;

#9. Write a SQL query to find those employees who joined before 1991. Return complete information about the employees.
select distinct concat(first_name,' ',last_name) as "Employee Name",hire_date,department_Id,job_Id,salary 
...
from employees,jobs where JOB_title='ANALYST';
